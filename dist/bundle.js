...
var ui = {
  renderPosts: function renderPosts(posts) {
    var element = posts.map(function (post) {
  ...
  renderUsers: function renderUsers(users) {
    var element = users.map(function (user) {
      var name = user.name,
          avatar = user.avatar;
...
var articleTemplate = function articleTemplate(title, lastReply) {
...
var userTemplate = function userTemplate(name, avatar) {
...
},{"./post":4,"xss-filters":1}],6:[function(require,module,exports){
"use strict";
